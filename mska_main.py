...
def main():
    ...
    parser.add_argument('--data_root', default="data",help='데이터 루트 디렉토리')
    parser.add_argument('--train_keypoint_dir', default="train/03_syn_word/03_syn_word_keypoint", help='훈련용 키포인트 디렉토리')
    parser.add_argument('--val_keypoint_dir', default="train/03_syn_word/03_syn_word_keypoint",help='검증용 키포인트 디렉토리')
    parser.add_argument('--train_morpheme_dir', default="train/03_syn_word/03_syn_word_morphemme",help='훈련용 morpheme.json')
    parser.add_argument('--val_morpheme_dir', default="train/03_syn_word/03_syn_word_morpheme",help='검증용 morpheme.json')
